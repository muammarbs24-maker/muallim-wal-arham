...
import {
  Clock, MapPin, Search, ChevronDown, CheckCircle2, User, Calendar, Info, RefreshCw, Sun, Sunset, Moon
} from 'lucide-react';
import {
  currentGuru, mockJadwal, mockJadwalMatrix, mockGuru, mockSesiList,
  syncMatrixToJadwal, loadPersistedData, mockSettings
} from '@/lib/mockData';
import type { DayOfWeek, Jadwal, JadwalSesiEntry, SesiConfig, SesiType, Guru, AppSettings } from '@/types';
...
export default function JadwalPage() {
  ...
  useEffect(() => {
    ...
    import('@/lib/supabaseClient').then(({ getJadwalMatrixSupabase, getSesiListSupabase, getAppSettingsSupabase, getGurusSupabase }) => {
