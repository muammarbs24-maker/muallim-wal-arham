...
export default function JadwalPage() {
  ...
  // 1. Pending incoming requests targeted to current teacher
  ...
  // 2. Resolved incoming requests targeted to current teacher (already accepted or rejected)
  ...
  // 3. Outgoing requests made by current teacher
